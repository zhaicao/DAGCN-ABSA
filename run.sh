...
# * DualGCN
# CUDA_VISIBLE_DEVICES=0 python ./DualGCN/train.py --model_name dualgcn --dataset restaurant --seed 1000 --num_epoch 50 --vocab_dir ./DualGCN/dataset/Restaurants --cuda 0 --losstype doubleloss --alpha 0.2 --beta 0.3 --parseadj
# * DualGCN with Bert
...
# * DualGCN
# CUDA_VISIBLE_DEVICES=0 python ./DualGCN/train.py --model_name dualgcn --dataset twitter --seed 1000 --num_epoch 50 --vocab_dir ./DualGCN/dataset/Tweets --cuda 0 --losstype doubleloss --alpha 0.3 --beta 0.2 --parseadj
# * DualGCN with Bert
