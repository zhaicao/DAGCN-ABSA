...
def parse_args():
    ...
    parser.add_argument('--data_dir', default='dataset/Restaurants', help='TACRED directory.')
    parser.add_argument('--vocab_dir', default='dataset/Restaurants', help='Output vocab directory.')
